...
static iomux_v3_cfg_t const led_pads[] = {
	MX6_PAD_UART1_CTS_B__GPIO1_IO18 | MUX_PAD_CTRL(MISC_PAD_CTRL), /* CPU_RED_LED# */
	MX6_PAD_UART1_RTS_B__GPIO1_IO19 | MUX_PAD_CTRL(MISC_PAD_CTRL), /* CPU_GRN_LED# */
};

#define EN_RED_LEDN		IMX_GPIO_NR(1, 18)
#define EN_GREEN_LEDN		IMX_GPIO_NR(1, 19)

static unsigned int saved_state[2] = {
	STATUS_LED_OFF,
	STATUS_LED_OFF
};
